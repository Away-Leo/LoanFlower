...
public class Urls extends ENUM_REQUEST_URL {
    //GET接口
    //"https://192.168.1.129:9999/"
    //"https://119.23.64.92/"外网
    //"https://192.168.1.100:1234/"内网
    //https://www.pingxundata.com/
    static { DOMAIN = "https://www.pingxundata.com"; }
//     static { DOMAIN="http://192.168.1.170:9999";}

    private static final String SERVER = DOMAIN + "/";

//    private static final String SERVER = "https://119.23.64.92/";
    ...
    public static final String URL_GET_MESSAGE_LIST=SERVER+"front/message/list.json";//消息列表
    public static final String URL_GET_MESSAGE_INFO=SERVER+"front/message/findById.json";//消息详情
    public static final String URL_GET_USER_INFO = SERVER + "front/userInfo/findById.json";//获取用户信息
    ...
    public static final String URL_POST_USER_INFO = SERVER + "front/userInfo/update.json";//用户信息保存及更新接口
}
