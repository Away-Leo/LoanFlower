...
//            public void run() {
//                page = 1;
//                ServerApi.postProductSearch(App.getAppContext(),ProductListRightFragment.this,page, REFRESH,zsType, InitDatas.RightCode);
//            }
//        },InitDatas.waitTime);
//    }
//
...
//                        public void run() {
//                            page++;
//                            ServerApi.postProductSearch(App.getAppContext(),ProductListRightFragment.this,page, LOADMORE,zsType,InitDatas.RightCode);
//                        }
//                    },1000);
//
//                } else {
...
//        if (message.message.equals(Constant.RefreshProductList)&&message.status==1) {
//            zsType=message.id;
//            bindingView.smartrefreshlayout.autoRefresh();
//        }
//    }
